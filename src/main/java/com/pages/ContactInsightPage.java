...
public class ContactInsightPage extends Baseclass {


	public ContactInsightPage(WebDriver driver) {
	...
	public void addNewContact() {
		...
		buttonclick(contactInsigtsSidemenu);
...
//		waitForLocator(contactSaved,originalsavemessage);
	...
	public void searchContact() {
		String firstname = jsonValues("firstname");
		String lastname = jsonValues("lastname");
		enterText(searchContact, firstname);
		assertEquals(getText(savedFirstName), firstname);
		assertEquals(getText(savedLastName), lastname);
